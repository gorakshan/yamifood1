...
<head>
	...
	<!-- Pickadate CSS -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/classic.css">    
	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/classic.date.css">    
	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/classic.time.css">    
    <!-- Responsive CSS -->
